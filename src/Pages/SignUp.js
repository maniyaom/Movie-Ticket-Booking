    ...
    if (isValid === true) {
      ...
      firebase
        ...
        .catch((error) => {
          ...
          else setError("Can't Sign Up, Unexpected error occured !!");
        })
        .finally(() => {
          setIsLoading(false);
        });
      ...
      >
        <div className="signup-card">
          ...
          <input
            ...
            className={`input-field ${
              phoneError !== "" ? "error-input-field" : ""
            }`}
            placeholder="e.g. 1234567890"
          />

          <label className="label-text">Want to list your show?</label>
          ...
          <div name="theater" className={isAdmin ? "" : "hide-div"}>
            ...
            <input
              ...
              className={`input-field ${
                theaterNameError !== "" ? "error-input-field" : ""
              }`}
            ...
            <textarea
              ...
              className={`input-field ${
                theaterAddressError !== "" ? "error-input-field" : ""
              }`}
          ...
          >
            ...
            <Link to="/Login" style={{ color: "#f84464" }}>
              Login
            </Link>
          </span>
        </div>
